...
void DownloadFile(std::string &ICAO_airport_name) {
    std::string http_link_airport_weather ="https://www.aviationweather.gov/adds/dataserver_current/httpparam?dataSource=tafs&requestType=retrieve&format=csv&stationString="+ICAO_airport_name+"%20&hoursBeforeNow=1";
